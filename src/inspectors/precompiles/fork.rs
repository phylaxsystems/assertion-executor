...
mod test {
    use super::*;
    use crate::{
        db::{MultiForkDb, overlay::test_utils::MockDb},
        primitives::JournaledState,
        test_utils::{run_precompile_test, random_address, random_u256},
    };
    use alloy_primitives::{Address, U256};
    use revm::{
        primitives::{AccountInfo, SpecId, KECCAK_EMPTY, Env, BlockEnv, CfgEnv, TxEnv},
    ...
    fn create_test_context_with_mock_db(
        ...
        for (address, slot, value) in pre_tx_storage {
            ...
            pre_tx_db.insert_account(address, AccountInfo {
                balance: U256::ZERO,
                nonce: 0,
        ...
        for (address, slot, value) in post_tx_storage {
            ...
            post_tx_db.insert_account(address, AccountInfo {
                balance: U256::ZERO,
                nonce: 0,
                code_hash: KECCAK_EMPTY,
                code: None,
